...
namespace Library_managements.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenDocGia = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ngayMuon = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LichSuMuon", x => x.maPhieuMuon);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    maPhieuTra = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    maPhieuMuon = table.Column<int>(nullable: false),
                    maSach = table.Column<int>(nullable: false),
                    ngayMuon = table.Column<DateTime>(nullable: true)
